...
/* Since I couldn't figure out how to divide 64 bit numbers
   I decided to find some code online, which implements 64 bit division.
   The below code is from: https://www.ida.liu.se/~TDIU25/pintos/src/lib/arithmetic.c */
...
extern "C" long long __moddi3 (long long n, long long d);
